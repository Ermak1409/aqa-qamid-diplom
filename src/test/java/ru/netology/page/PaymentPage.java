...
public class PaymentPage {
    ...
    private SelenideElement yearErrorFuture = $(byText("Неверно указан срок действия карты")).parent().$(".input__sub");
    ...
    public void yearErrorFuture() {
        yearErrorFuture.shouldBe(visible);
    }
